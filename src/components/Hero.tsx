...
import wireframeImg from "../../public/img/wireframe.png";
import popupImg from "../../public/img/popup.png";

export const Hero = () => {
  return (
    <>
      <Container className="flex flex-wrap w-[90%]">
        <div className="flex items-center w-5/6 lg:w-1/3">
          <div className="max-w-2xl mb-8">
            <h1 className="text-4xl font-bold leading-snug tracking-tight text-gray-800 lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white">
              Simplify Compliance,{" "}
              <span className="text-main">Maximize Warranties</span>
            </h1>
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-l xl:text-l dark:text-gray-300">
              Gain visability into the state of your warranties. Discover
              one-click uploads of warranties to simplify maintenance and ensure
              compliance.
            </p>
        ...
        <div className="flex items-center justify-center w-full lg:w-2/3">
          <div className="">
            <div className="grid place-items-end relative w-full h-64 md:h-80 lg:h-96">
              <Image
                src={wireframeImg}
                width="616"
                height="617"
      ...
      {/* <Container>
        <div className="flex flex-col justify-center">
          <div className="text-xl text-center text-gray-700 dark:text-white">
            Trusted by <span className="text-main">2000+</span> customers
            worldwide
          </div>
